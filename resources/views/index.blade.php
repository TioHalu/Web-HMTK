...
<div class="welcome">
    <div class="container">
        <div class="row gx-5 align-items-center">
            ...
            <div class="col-lg-6">
              <img src="{{asset('assets/img/People.png')}}" class="img-fluid" width="500px" style="margin-top: -70px;">
            </div>
        </div>
    </div>
</div>
...
<div id="carouselExampleControls" class="carousel slide carousel-custom" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="{{asset('assets/img/hmtk.png')}}" alt="First slide">
    </div>
    
    <div class="carousel-item">
      <img class="d-block w-100" src="{{asset('assets/img/hmtk.png')}}" alt="Second slide">
    </div>
    
    <div class="carousel-item">
      <img class="d-block w-100" src="{{asset('assets/img/hmtk.png')}}" alt="Third slide">
    </div>
  </div>
...
<div class="container">
  <center>
    <div class="Card2" style="background-image: url({{asset('assets/img/wisuda.png')}});">
      <div class="overlay">
      <a class="link" data-toggle="modal" data-target="#exampleModal1" href="">Open</a>
      </div>
    </div>
    
    <div class="Card2" style="background-image: url({{asset('assets/img/gunung.png')}});">
      <div class="overlay">
        <a class="link" data-toggle="modal" data-target="#exampleModal2" href="">Open</a>
      </div>
    </div>

    <div class="Card2" style="background-image: url({{asset('assets/img/basket.png')}});">
      <div class="overlay">
        <a class="link" href="">Open</a>
      </div>
    </div>

    <div class="Card2" style="background-image: url({{asset('assets/img/kabinet.png')}});">
      <div class="overlay">
        <a class="link" href="">Open</a>
      </div>
    </div>

    <div class="Card2" style="background-image: url({{asset('assets/img/juara.png')}});">
      <div class="overlay">
        <a class="link" href="">Open</a>
      </div>
    </div>

    <div class="Card2" style="background-image: url({{asset('assets/img/penghargaan.png')}});">
      <div class="overlay">
  ...
  <div class="modal-dialog modal-dialog-centered modal-xl">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <center>
          <img src="{{asset('assets/img/wisuda.png')}}" class="img-fluid">
          <p>Deskripsi Foto</p>
        </center>
      </div>
...
<div class="modal fade modal-custom" id="exampleModal2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-xl">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <center>
          <img src="{{asset('assets/img/hmtk.png')}}" class="img-fluid">
